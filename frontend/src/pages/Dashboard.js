...
import { getSavedTracks, getFollowedArtists, formatNumber } from "../api";

export default function Dashboard({ spotifyUser, isLoggedIn, onSpotifyConnect }) {
          ...
          <div className="hero-content">
            {isLoggedIn ? (
              <>
                ...
                <button onClick={onSpotifyConnect} className="btn btn-spotify" style={{ marginTop: 16, border: "none", cursor: "pointer", fontFamily: "inherit" }}>
              ...
              <>
                <h2>Erstelle einen Account um loszulegen</h2>
                <p>Registriere dich oder melde dich an, um deinen Spotify-Account zu verknüpfen und alle Features zu nutzen.</p>
                <button onClick={() => navigate("/auth")} className="btn btn-primary" style={{ marginTop: 16 }}>
                  Jetzt registrieren
                </button>
              </>
            )}
